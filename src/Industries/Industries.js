...
function Industries(props) {
  ...
  const buildingIcon = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
    ...
    <div>
      <table width='100%'>
        <tr>
          ...
          <th className={styles.right} width='12%'>Occupation Jobs in Industry ({industryData.year})</th>
          <th className={styles.right} width='12%'>% of Occupation in Industry ({industryData.year})</th>
          <th className={styles.right} width='12%'>% of Total Jobs in Industry ({industryData.year})</th>
        </tr>
